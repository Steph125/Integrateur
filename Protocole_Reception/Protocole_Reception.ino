...
//Les codes d'identification pour les groupes et les destinataires permettent de filtrer les messages radio selon leur origine et leur destination. Ainsi, le PC ne reçoit que les messages qui lui sont adressés, et peut identifier le groupe qui les envoie. Cela évite de recevoir des messages indésirables ou de confondre les sources.
...
//Ports 
int portReception = 12;//Port de réception radio
